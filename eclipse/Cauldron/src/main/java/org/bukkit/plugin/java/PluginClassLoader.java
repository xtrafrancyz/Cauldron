...
public class PluginClassLoader extends URLClassLoader {
    ...
    PluginClassLoader(final JavaPluginLoader loader, final URL[] urls, final ClassLoader parent, PluginDescriptionFile pluginDescriptionFile) { // Cauldron - add PluginDescriptionFile
        ...
        debug = CauldronConfig.getBoolean("plugin-settings.default.debug", false);
        ...
        boolean remapNMS151 = CauldronConfig.getBoolean("plugin-settings.default.remap-nms-v1_5_R2", true);
        boolean remapNMS150 = CauldronConfig.getBoolean("plugin-settings.default.remap-nms-v1_5_R1", true);
        boolean remapNMS147 = CauldronConfig.getBoolean("plugin-settings.default.remap-nms-v1_4_R1", true);
        boolean remapNMS146 = CauldronConfig.getBoolean("plugin-settings.default.remap-nms-v1_4_6", true);
        String remapNMSPre = CauldronConfig.getString("plugin-settings.default.remap-nms-pre", "false");
        boolean remapOBC164 = CauldronConfig.getBoolean("plugin-settings.default.remap-obc-v1_6_R3", false);
        boolean remapOBC162 = CauldronConfig.getBoolean("plugin-settings.default.remap-obc-v1_6_R2", false);
        boolean remapOBC161 = CauldronConfig.getBoolean("plugin-settings.default.remap-obc-v1_6_R1", false);
        boolean remapOBC152 = CauldronConfig.getBoolean("plugin-settings.default.remap-obc-v1_5_R3", true);
        boolean remapOBC151 = CauldronConfig.getBoolean("plugin-settings.default.remap-obc-v1_5_R2", true);
        boolean remapOBC150 = CauldronConfig.getBoolean("plugin-settings.default.remap-obc-v1_5_R1", true);
        boolean remapOBC147 = CauldronConfig.getBoolean("plugin-settings.default.remap-obc-v1_4_R1", false);
        boolean remapOBC146 = CauldronConfig.getBoolean("plugin-settings.default.remap-obc-v1_4_6", false);
        ...
        debug = CauldronConfig.getBoolean("plugin-settings."+pluginName+".debug", debug, false);
        ...
        remapNMS151 = CauldronConfig.getBoolean("plugin-settings."+pluginName+".remap-nms-v1_5_R2", remapNMS151, false);
        remapNMS150 = CauldronConfig.getBoolean("plugin-settings."+pluginName+".remap-nms-v1_5_R1", remapNMS150, false);
        remapNMS147 = CauldronConfig.getBoolean("plugin-settings."+pluginName+".remap-nms-v1_4_R1", remapNMS147, false);
        remapNMS146 = CauldronConfig.getBoolean("plugin-settings."+pluginName+".remap-nms-v1_4_6", remapNMS146, false);
        ...
        remapOBC151 = CauldronConfig.getBoolean("plugin-settings."+pluginName+".remap-obc-v1_5_R2", remapOBC151, false);
        remapOBC150 = CauldronConfig.getBoolean("plugin-settings."+pluginName+".remap-obc-v1_5_R1", remapOBC150, false);
        remapOBC147 = CauldronConfig.getBoolean("plugin-settings."+pluginName+".remap-obc-v1_4_R1", remapOBC147, false);
        remapOBC146 = CauldronConfig.getBoolean("plugin-settings."+pluginName+".remap-obc-v1_4_6", remapOBC146, false);
