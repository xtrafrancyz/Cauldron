...
public class DimensionManager
{
    ...
    public static boolean registerProviderType(int id, Class<? extends WorldProvider> provider, boolean keepLoaded)
    {
        ...
        keepLoaded = net.minecraftforge.cauldron.configuration.CauldronConfig.getBoolean("world-environment-settings." + worldType + ".keep-world-loaded", keepLoaded);
        net.minecraftforge.cauldron.configuration.CauldronConfig.save();
        // Cauldron end
    ...
    public static Integer[] getIDs(boolean check)
    {
        ...
        if (net.minecraftforge.cauldron.configuration.CauldronConfig.worldLeakDebug.getValue())
        {
            if (check)
            {
    ...
    public static void initDimension(int dim) {
        ...
        // Cauldron start - add ability to disable dimensions
        boolean enabled = net.minecraftforge.cauldron.configuration.CauldronConfig.getBoolean("world-environment-settings." + worldType + ".enabled", true);
        net.minecraftforge.cauldron.configuration.CauldronConfig.save();
        if (!enabled)
            return;
        // Cauldron end
