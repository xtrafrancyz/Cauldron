...
public class BlockFlowing extends BlockFluid
{
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (l > 0)
        {
            ...
            if(net.minecraftforge.cauldron.configuration.CauldronConfig.infiniteWaterSource.getValue())
            {
            ...
            if (j1 == l)
            {
                ...
                else if (net.minecraftforge.cauldron.configuration.CauldronConfig.flowingLavaDecay.getValue())
                {
